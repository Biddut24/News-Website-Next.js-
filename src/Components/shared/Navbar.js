      ...
      <div className="navbar bg-black shadow-sm px-5">
        <div className="navbar-start">
          <div className="dropdown">
            <div tabIndex={0} role="button" className="btn mr-7 bg-white btn-ghost lg:hidden">
              <svg
         ...
         {
          navItems.map((item, i) => <li key={i}> <Link href={item.path} className="text-Black">  {item.route}</Link> </li>)
          }
